...
func (dc *DefaultCollector) Collect(metric *NodeMetric) error {
...
func (*CPUCollector) Collect(metric *NodeMetric) error {
	before, err := cpu.Get()
	if err != nil {
...
func (*MemoryCollector) Collect(metric *NodeMetric) error {
...
func (*DiskCollector) Collect(metric *NodeMetric) error {
	disks, err := disk.Get()
	if err != nil {
...
func (*NetCollector) Collect(metric *NodeMetric) error {
	var (
