...
func processdata(rawMetric *metrics.NodeMetric) {
	// 查询往期的记录
	...
	record.Metrics = append(record.Metrics, metrics.NodeFullMetric{
		RawMetric:  *rawMetric,
...
func checkIfOffline(record *metrics.NodeInfoRecord) {
